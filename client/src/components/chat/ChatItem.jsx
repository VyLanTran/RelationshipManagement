...
const ChatItem = ({ chat }) => {
  ...
  return (
    <Card
      className={`flex flex-row p-2 py-3 gap-4 border-none shadow-none cursor-pointer hover:bg-gray-100 rounded-none
    ...
    >
      ...
      <div className="flex flex-col items-start">
        ...
        <span className="font-semibold text-[16px]">{chat.chatName}</span>
