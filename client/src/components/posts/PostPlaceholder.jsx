    ...
    return (
        <div className="w-[70vh] mt-[2vh] rounded-[20px]  flex flex-col h-auto overflow-y-auto ">
            <div className="author flex flex-row ml-0">
                {user.profilePicture ? <img src={user.profilePicture.url} alt="avatar" className="avatar w-[5vh] h-[5vh] m-2 rounded-[20px] border-none" /> : <img src={placeholderAvatar} alt="avatar" className="avatar w-[5vh] h-[5vh] m-2 rounded-[20px] border-none" />}
